...
// providers
import { ITableContext } from './providers/table-provider';
export type { ITableContext };

export { default as TableContext } from './providers/table-provider';
export { default as TableRowContext } from './providers/table-row-provider';
